...
import MovingLineBorderCard from "./MovingLineBorder";

export const BoxCard = ({ title, description, imageUrl }) => {
  return (
    <div className="bg-white h-full w-2/3 md:w-1/3  mb-20  rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 ease-in-out">
      <MovingLineBorderCard className="">
